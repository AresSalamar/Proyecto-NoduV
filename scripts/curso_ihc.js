...
document.addEventListener('DOMContentLoaded', function () {
    ...
    auth.onAuthStateChanged(user => {
        if (user) {
            ...
            // Iniciar las lógicas que dependen del usuario
            initializePageLogic();
    ...
    /**
     * Función principal que se ejecuta una vez que el usuario está autenticado.
     */
    function initializePageLogic() {
        
        // --- Lógica de Navegación de Apuntes de IHC ---
        ...
        setupCourseNotesToggle('ihc', [
            { id: 'heuristics', backBtnId: null },
            { id: 'wireframes', backBtnId: 'wireframes' },
            { id: 'webdesign', backBtnId: 'webdesign' },
            { id: 'mobileui', backBtnId: 'mobileui' }
        ]);
        ...
        let tasks = [
            { id: 3, text: 'Bocetar prototipo de la app.', completed: false }
        ...
        // --- Lógica de "Mi Biblioteca" (Favoritos) ---
        ...
        function handleBookmarkClick(e) {
            ...
            if (!apunte.id) {
                console.error("Error: El apunte no tiene ID (data-id)");
                return;
            }
        ...
        // Iniciar listeners de marcadores
